...
class CDDDataSet(data.Dataset):
    def __init__(self, data_dir, list_path, max_iters=None, set='train'):
        self.mean = [103.5061, 113.4304, 105.4610]
        self.std = [61.7836, 64.5690, 60.5640]
...
if __name__ == '__main__':
    ...
    train_dataset = CDDDataSet(data_dir='/root/datasets/Building_Change/',list_path='train.txt')
    ...
    print(mean, std)
    #tensor([103.5061, 113.4304, 105.4610]) tensor([61.7836, 64.5690, 60.5640])
    print(weight) 
    #[[0.88299891 0.11700109]]
    print(1./weight) 
    #[[1.13250422 8.54692918]]